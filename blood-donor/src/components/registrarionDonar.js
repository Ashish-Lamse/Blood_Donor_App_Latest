...
class RegistrationForm extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Panel header="Registration Page" bsStyle="default">
                    <Form horizontal >
                        <Panel header="Personal Details"  bsStyle="default">
                            <FormGroup >
                        ...
                        <Col sm={6}>
                            <Panel header="Personal contact details"  bsStyle="default">
                        ...
                        <Col sm={6}>
                            <Panel header="Emergency contact details"  bsStyle="default">
                        ...
                        <FormGroup>
                            <Col smOffset={2} sm={10}>
                                <Button type="button" className="pull-right" bsStyle="default" bsSize="large"  disabled={pristine || submitting} onClick={ () => this.NEW_DONAR_REGISTERED_DATA() }>
                                    Register
                                </Button>
                            </Col>
                        </FormGroup>
